...
if( $_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  //To update the data of the client
  $id = $_POST["id"];
  $ecode = $_POST["ecode"];
  $ename = $_POST["ename"];
  $eemail = $_POST["eemail"];
  ...
  do {
    if( empty($id) || empty($ecode) || empty($ename) ||empty($eemail) || empty($epassword) || empty($pid) || empty($bid) || empty($photo) ){
      $errorMessage = "All the fields are required";
      break;
    }

    $sql = "UPDATE pengguna
            SET ecode='$ecode', ename='$ename', eemail='$eemail', epassword='$epassword', pid='$pid', bid='$bid', photo='$photo'
            WHERE id=$id";
    ...
    $successMessage = "User berhasil di update";
...
<tbody>
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Ubah Data<small> Pengguna</small></h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="box box-solid">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><b>Ubah Data Pengguna</b></h3>
            </div>
                ...
                <form method="POST">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="ecode" value="<?php echo $ecode; ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="eemail" value="<?php echo $eemail; ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="password" class="form-control" name="epassword" value="<?php echo $epassword; ?>">
                      </div>
                    </div>
