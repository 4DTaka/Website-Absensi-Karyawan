...
if( $_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  do {
    if( empty($id) || empty($nm) || empty($un) ||empty($email) || empty($pass) || empty($lvl) ){
      $errorMessage = "All the fields are required";
      break;
    }

    $sql = "UPDATE pemilik
            SET nm='$nm', un='$un', email='$email', pass='$pass', lvl='$lvl'
            WHERE id=$id";
...
-->
  ...
  <meta content="Indonesia" name="geo.placun"/>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <a href="pengguna.php">
            <i class="fa fa-database"></i> <span>Data Administrator</span>
          </a>
...
<tbody>
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Ubah Data<small> Administrator</small></h1>
      <ol class="breadcrumb">
        <li><a href="pengguna.php"><i class="fa fa-dashboard"></i> Beranda</a></li>
        <li><a href="administrator.php"> Data Administrator</a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="box box-solid">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><b>Ubah Data Administrator</b></h3>
            </div>
                ...
                <form method="POST">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="un" value="<?php echo $un; ?>">
                      </div>
                    </div>
                    ...
                    <div class="box-footer">
                      <div class="col-sm-2"></div>
                        ...
                        <a class="btn btn-danger" href="administrator.php"><i class="fa fa-remove"></i> Batal</a>
                    </div>
