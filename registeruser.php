    ...
    <div id="appCapsule">
       <h4 style="color:#029DD6;font-size: 20px;padding-top:10px;"class="section text-center">Pusat Pengajaran dan Pembelajaran Inovatif</h4>
        <div style=" background-image: url(BAHAN/batik.png); background-color:#029DD6;border-radius:30px;margin:0 16px;padding:10px 15px" class="section text-center">
            <h1 style="color:#FFFFFF;font-size:19px;"><i class="fa fa-user-plus"></i> Registrasi</h1>
            <img src="BAHAN/register.png" height="90">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <select class="form-control" name="position_id" id="position_id"  required="">
                                  <option value="">- Pilih -</option><option value="2">STAFF</option><option value="7">PART-TIME</option><option value="1">MAGANG</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <select class="form-control" name="building_id" id="building" required="">
                                  <option value="">- Pilih -</option><option value="2">P3I</option><option value="1">WFH</option>
                              </select>
                            </div>
                        </div>
